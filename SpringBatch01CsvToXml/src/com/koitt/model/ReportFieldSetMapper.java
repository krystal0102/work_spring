 ...
 * 
 * 데이터 타입 변환이 필요 없다면, BeanWrapperFiledSetMapper 를 이용해서 이름 기준으로 자동으로 연결(Mapping)하면 된다
 */

public class ReportFieldSetMapper implements FieldSetMapper<Report> {
	
	// 파일로부터 입력받는 데이터 형태를 컴퓨터가 알 수 있게 하기 위한 필드
	...
	public Report mapFieldSet(FieldSet fieldSet) throws BindException {
		...
		// dd/MM/yyyy 형식을 Date클래스 타입으로 변경하여 저장
