...
public class TestDrive02 {
	public static void main(String[] args) {
		...
		emp = template.queryForObject(sql, new BeanPropertyRowMapper<Employee>(Employee.class), 7839);
		System.out.println(emp);
		System.out.println();
		...
		// 5. 테이블 2개를 조인한 결과를 객체에 어떻게 담아야 하는지에 대한 예제
		...
		// 익명 클래스(Annonymous class) : 아래 코드 66번 중괄호 시작부터 95번 중괄호 끝나는 부분까지
